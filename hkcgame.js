...
function choiceselected(answer, isChoiceSelected){
    ...
    if(userAns == correcAns){ //if user selected choice is equal to array's correct answer
        ...
        answer.insertAdjacentHTML("beforeend", grinFaceTag); //adding tick icon to correct selected choice
        ...
        answer.insertAdjacentHTML("beforeend", sadFaceTag); //adding cross icon to correct selected choice
        ...
        if(time < 0){
            ...
            for(i=0; i < allchoices; i++){
                if(choices_list.children[i].textContent == correcAns){ //if there is an choice which is matched to an array answer
                    ...
                    choices_list.children[i].insertAdjacentHTML("beforeend", grinFaceTag); //adding tick icon to matched choice
